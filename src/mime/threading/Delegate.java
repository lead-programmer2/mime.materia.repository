...
public class Delegate {
     ...
     */
    public Delegate(Invokable invokingmethod) {
    ...
    * Creates a new instance of Delegate.
     ...
     */
    public Delegate(Invokable invokingmethod, Invokable callback) {
    ...
    public void invoke() {
        ...
        if (_progress!=null) {
            Delegate _progressdelegate=new Delegate(new Invokable() {
